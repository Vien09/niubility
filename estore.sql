...
CREATE TABLE `orders` (
  ...
  KEY `user_id` (`user_id`),
  KEY `state` (`state`),
  CONSTRAINT `state` FOREIGN KEY (`state`) REFERENCES `order_status` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `user_id_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('12', '1', '111', '1', '2021-10-14 21:34:33');
...
INSERT INTO `order_status` VALUES ('4', '待评价');
...
INSERT INTO `products` VALUES ('29', 'ee', '123', '12', '0', null, 'wu', 'red');
...
CREATE TABLE `shopping_cart` (
  ...
  `prod_id` int(10) NOT NULL COMMENT 'sku_id',
  `set_num` int(20) NOT NULL DEFAULT '1',
  PRIMARY KEY (`user_id`,`prod_id`),
  KEY `book_id1` (`prod_id`),
  CONSTRAINT `prod_id1` FOREIGN KEY (`prod_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- ----------------------------
INSERT INTO `shopping_cart` VALUES ('1', '1', '2');
INSERT INTO `shopping_cart` VALUES ('1', '26', '2');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', 'enen', '123', '77363191@qq.com', 'user', '1', 'afd7a459-b948-4239-9ad6-29c5a172fa1e', '2021-10-06 15:15:37');
...
CREATE TABLE `user_addr` (
  ...
  `consignee` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'received_person',
  `phone_no` char(11) NOT NULL,
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `default_addr` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
