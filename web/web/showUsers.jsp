        ...
        <table border="1" align="center" width="85%">
            ...
            <c:forEach items="${ulist}" var="u">
                <tr>
                    ...
                    <td>${u.email }</td>
                    <td>${u.updatetime }</td>
                    <td><a href="${pageContext.request.contextPath}/GetUserOrderServlet?id=${u.id}">订单信息</a></td>
                    <td><a href="${pageContext.request.contextPath}/ProductEditServlet?id=${u.id}">编辑</a>
