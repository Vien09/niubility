...
<head>
    ...
    <script type="text/javascript">
        ...
        function tocart() {
            ...
            location.href = "http://localhost:8080/Estore/showCartServlet";
            </c:if>
...
<%--                <a class="logout" href="${pageContext.request.contextPath}/ShowAllAddressServlet">地址</a>--%>
            </c:if>
			<c:if test="${ empty user }">
...
<%--            <form id="sign-form-1" action="${pageContext.request.contextPath}/UserServlet.login" method="post">--%>
...
<%--            <form id="sign-form-2" action="${pageContext.request.contextPath}/UserServlet.register" method="post">--%>
